      ...
      <div class="w-full lg:max-w-sm mx-auto space-y-10" uk-scrollspy="target: > *; cls: uk-animation-scale-up; delay: 100 ;repeat: true">
        ...
        <form method="#" action="#" class="space-y-7 text-sm text-black font-medium dark:text-white"  uk-scrollspy="target: > *; cls: uk-animation-scale-up; delay: 100 ;repeat: true">
          ...
          <div>
            ...
            <div class="mt-2.5">
              <input id="email" v-model="form.email" name="email" type="email" autofocus=""  placeholder="Email" required="" class="!w-full !rounded-lg !bg-transparent !shadow-sm !border-slate-200 dark:!border-slate-800 dark:!bg-white/5" :readonly="loading">
            </div>
          </div>
          <!-- password -->
          <div>
            ...
            <div class="mt-2.5">
              <input id="password" v-model="form.password" name="password" type="password"   class="!w-full !rounded-lg !bg-transparent !shadow-sm !border-slate-200 dark:!border-slate-800 dark:!bg-white/5" :readonly="loading">
            </div>
          </div>
          ...
          <div>
            ...
            <button @click.prevent="login"  class="button bg-primary text-white w-full">
