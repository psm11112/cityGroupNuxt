...
// const { data: thing } = await useFetch(
//   "http://127.0.0.1:8000/api/encrypt-value/" + auth.user.id
// ).then((res) => {
//   console.log(res);
...
onMounted(async () => {
  ...
  nextTick(async () => {
    const { data } = await useFetch("/encrypt-value/" + auth.user.id, {
      ...
      <div class="2xl:w-[--w-side] lg:w-[--w-side-sm]">
        ...
        <div class="flex items-center gap-1">
          ...
          <div id="logo">
            <a href="feed.html">
              <img
                src="../public/assets/images/logo-city.png"
                alt=""
          ...
          >
            ...
            >
              ...
              <nav class="text-sm font-medium text-black dark:text-white">
                ...
                >
                  <img
                    src="../public/assets/images/avatars/avatar-2.jpg"
                ...
                >
                  <img
                    src="../public/assets/images/group/group-2.jpg"
                    class="w-9 h-9 rounded-full"
                  />
                  <div>
                ...
                >
                  <img
                    src="../public/assets/images/group/group-1.jpg"
                    class="w-9 h-9 rounded-full"
                  />
                  <div>
                    <div>Delicious Foods</div>
                ...
                >
                  <img
                    src="../public/assets/images/avatars/avatar-6.jpg"
                    class="w-9 h-9 rounded-full"
                  />
                  <div>
                    <div>John Welim</div>
                ...
                <a
                  ...
                  class="hidden relative px-3 py-1.5 flex items-center gap-4 hover:bg-secondery rounded-lg dark:hover:bg-white/10"
                >
                  <ion-icon class="text-2xl" name="search-outline"></ion-icon> 8
                  Facts About Writting
                </a>
              </nav>
              <hr class="-mx-2 mt-2 hidden" />
              <div
                class="flex justify-end pr-2 text-sm font-medium text-red-500 hidden"
              >
                <a
                  href="#"
                  class="flex hover:bg-red-50 dark:hover:bg-slate-700 p-1.5 rounded"
                >
                  <ion-icon name="trash" class="mr-2 text-lg"></ion-icon> Clear
                  your history</a
                >
              </div>
            </div>
          ...
          >
            ...
            >
              ...
              >
                ...
                >
                  <img
                    src="../public/assets/images/icons/group.png"
                    alt=""
                    class="w-7"
                  />
                  <div class="flex-1">
                ...
                >
                  <img
                    src="../public/assets/images/icons/page.png"
                    alt=""
                    class="w-7"
                  />
                  <div class="flex-1">
                ...
                >
                  <img
                    src="../public/assets/images/icons/event.png"
                    class="w-7"
                  />
                  <div class="flex-1">
                    <a href="timeline.html"
                ...
                >
                  <img
                    src="../public/assets/images/icons/market.png"
                    class="w-8 -ml-1"
                  />
                  <div class="flex-1">
                    <a href="timeline.html"
                ...
                >
                  <img
                    src="../public/assets/images/icons/game.png"
                    alt=""
                    class="w-7"
                  />
                  <div class="flex-1">
                ...
                <div class="pl-2 p-1 text-sm font-normal dark:text-white">
                  ...
                  >
                    <div class="relative w-12 h-12 shrink-0">
                      <img
                        src="../public/assets/images/avatars/avatar-3.jpg"
                        alt=""
                  ...
                  >
                    <div class="relative w-12 h-12 shrink-0">
                      <img
                        src="../public/assets/images/avatars/avatar-7.jpg"
                        alt=""
                        class="object-cover w-full h-full rounded-full"
                      />
                    </div>
                    <div class="flex-1">
                      <p>
                        <b class="font-bold mr-1">Jesse Steeve</b> mentioned you
                  ...
                  >
                    ...
                    <div class="flex-1">
                      <p>
                        <b class="font-bold mr-1"> Alexa stella</b> commented on
                  ...
                  >
                    ...
                    <div class="flex-1">
                      <p>
                        <b class="font-bold mr-1"> John Michael</b> who you
                  ...
                  >
                    ...
                    <div class="flex-1">
                      <p>
                        <b class="font-bold mr-1"> Sarah Gray</b> sent you a
                  ...
                  >
                    <div class="relative w-12 h-12 shrink-0">
                      <img
                        src="../public/assets/images/avatars/avatar-4.jpg"
                        alt=""
                        class="object-cover w-full h-full rounded-full"
                      />
                    </div>
                    <div class="flex-1">
                      <p>
                        <b class="font-bold mr-1"> Jesse Steeve</b> sarah tagged
                        you <br />
                  ...
                  >
                    ...
                    <div class="flex-1">
                      <p>
                        <b class="font-bold mr-1"> Lewis Lewis</b> mentioned you
                        in a story. Check it out and reply. 📣
                      </p>
                      <div
                        class="text-xs text-gray-500 mt-1.5 dark:text-white/80"
                  ...
                  >
                    ...
                    <div class="flex-1">
                      <p>
                        <b class="font-bold mr-1"> Martin Gray</b> liked your
            ...
            >
              ...
              <div class="flex items-center justify-between gap-2 p-4 pb-1">
                ...
                <div
                  class="flex gap-2.5 text-lg text-slate-900 dark:text-white"
                >
              ...
              <div class="h-80 overflow-y-auto pr-2">
                <div class="p-2 pt-0 pr-1 dark:text-white/80">
                  ...
                  >
                    <div class="relative w-10 h-10 shrink-0">
                      <img
                        src="../public/assets/images/avatars/avatar-5.jpg"
                        alt=""
                        class="object-cover w-full h-full rounded-full"
                      />
                    </div>
            ...
            >
              <a href="timeline.html">
                <div class="p-4 py-5 flex items-center gap-4">
                  ...
                  />
                  <div class="flex-1">
                    <h4 class="text-sm font-medium text-black" v-if="auth.user">
                      {{ auth.user.name }}
                    </h4>
                    <div
              ...
              <nav class="p-2 text-sm text-black font-normal dark:text-white">
                ...
                <a :href="  +'/admin-login/' + token">
                  ...
                  >
                    ...
                    >
                      <g fill="#FFFFFF">
                        <path d="M208 72v112H48V72Z" opacity=".2"></path>
                        <path
                          d="M88 144v-16a8 8 0 0 1 16 0v16a8 8 0 0 1-16 0Zm40 8a8 8 0 0 0 8-8v-24a8 8 0 0 0-16 0v24a8 8 0 0 0 8 8Zm32 0a8 8 0 0 0 8-8v-32a8 8 0 0 0-16 0v32a8 8 0 0 0 8 8Zm56-72v96h8a8 8 0 0 1 0 16h-88v17.38a24 24 0 1 1-16 0V192H32a8 8 0 0 1 0-16h8V80a16 16 0 0 1-16-16V48a16 16 0 0 1 16-16h176a16 16 0 0 1 16 16v16a16 16 0 0 1-16 16Zm-80 152a8 8 0 1 0-8 8a8 8 0 0 0 8-8ZM40 64h176V48H40Zm160 16H56v96h144Z"
                        ></path>
                      </g>
                    </svg>
            ...
            <NuxtLink
              v-if="!auth.user"
              to="/login"
              class="p-2 rounded-lg font-bold bg-blue-600 flex space-x-1 sm:p-1 p-1 relative dark:text-white"
            >
              Login
            </NuxtLink>
          </div>
