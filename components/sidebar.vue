          ...
          <ul>
            ...
            <li>
              <NuxtLink to="/featured" >
                <img
                  src="../public/assets/images/icons/message.png"
                  alt="messages"
                  class="w-5"
                />
                <span> Featured </span>
...
<!--              <a href="blog-2.html">-->
<!--                <img-->
<!--                  src="../public/assets/images/icons/blog-2.png"-->
<!--                  alt="blog"-->
<!--                  class="w-6"-->
<!--                />-->
<!--                <span> blog II </span>-->
...
<!--              <a href="event-2.html">-->
<!--                <img-->
<!--                  src="../public/assets/images/icons/event-2.png"-->
<!--                  alt="event"-->
<!--                  class="w-6"-->
<!--                />-->
<!--                <span> Event II </span>-->
...
<!--                <img-->
<!--                  src="../public/assets/images/icons/group-2.png"-->
<!--                  alt="groups"-->
<!--                  class="w-6"-->
<!--                />-->
<!--                <span> Groups II </span>-->
...
<!--                <ion-icon-->
<!--                  name="chevron-down"-->
<!--                  class="text-base ml-auto duration-200 group-aria-expanded:rotate-180"-->
<!--                ></ion-icon>-->
<!--              </a>-->
<!--              <ul class="pl-10 my-1 space-y-0 text-sm">-->
<!--                <li>-->
<!--                  <a href="components.html" class="!py-2 !rounded -md"-->
<!--                    >Elements</a-->
<!--                  >-->
<!--                </li>-->
<!--                <li>-->
...
<!--        <div-->
<!--          class="text-xs font-medium flex flex-wrap gap-2 gap-y-0.5 p-2 mt-2"-->
<!--        >-->
